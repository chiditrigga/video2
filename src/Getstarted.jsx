   ...
   {/* first ###################start############################# */}
    ...
    <Col xs={12}>
      ...
      <p>Share your video </p>
       ...
       <Button variant="outline-primary"> <Image fluid src={fb} /> Facebook</Button >
        <Button variant="outline-success">WhatsApp</Button>
     ...
     <Container fluid>
      <Row className='py-5 pt-3'>
        <Col xs={12} style={{background:"rgba(231, 231, 237, 0.2)"}} className='text-md-center '> 
